...
http.createServer(async (req, res) => {
    ...
    if (req.url === '/dashboard' || req.url === '/') {
        ...
        const dashboardHTML = [
            ...
            "        /* APPLE MAC VISUAL THEME OVERRIDES */",
            "        :root { --bg-main:#e9edf3; --bg-card:rgba(255,255,255,0.72); --border-color:rgba(18,18,18,0.08); --text-main:#0f172a; --text-muted:#64748b; --accent-blue:#0a84ff; --accent-green:#34c759; --accent-purple:#bf5af2; --accent-orange:#ff9f0a; --accent-pink:#ff375f; --accent-red:#ff453a; }",
            ...
            "        .nav-btn.active { border-left: 0; border: 1px solid rgba(10,132,255,0.24); background: rgba(10,132,255,0.15); color: #0a84ff; box-shadow: inset 0 1px 0 rgba(255,255,255,0.65); }",
            "        .main-content { background: linear-gradient(180deg, rgba(255,255,255,0.66) 0%, rgba(252,252,253,0.72) 100%); }",
            "        .top-bar { background: rgba(255,255,255,0.7); border: 1px solid rgba(15,23,42,0.08); border-radius: 16px; padding: 14px 18px; box-shadow: 0 8px 20px rgba(15,23,42,0.08); backdrop-filter: blur(16px); }",
            "        .mac-traffic { display:flex; gap:8px; margin-right:14px; }",
            "        .mac-traffic span { width:12px; height:12px; border-radius:50%; display:inline-block; box-shadow: inset 0 -1px 2px rgba(0,0,0,0.2); }",
            "        .mac-traffic span:nth-child(1){ background:#ff5f57; }",
            "        .mac-traffic span:nth-child(2){ background:#febc2e; }",
            "        .mac-traffic span:nth-child(3){ background:#28c840; }",
            "        .hamburger-btn { color:#334155; }",
            "        .btn-icon, .admin-btn { background: rgba(255,255,255,0.8); border: 1px solid rgba(15,23,42,0.12); color: #0f172a; box-shadow: 0 6px 14px rgba(15,23,42,0.08); }",
            "        .btn-icon:hover, .admin-btn:hover { transform: translateY(-1px); box-shadow: 0 10px 18px rgba(10,132,255,0.2); border-color: rgba(10,132,255,0.36); color: #0a84ff; }",
            "        .card, .box, .product-card, .kanban-col, .ticket-list, .chat-window { background: rgba(255,255,255,0.72); border: 1px solid rgba(15,23,42,0.1); box-shadow: 0 10px 24px rgba(15,23,42,0.08); backdrop-filter: blur(16px); }",
            "        .card::before { opacity: 0.32; }",
            "        .card h3, .box h2, th { color: #667085; }",
            "        .card .value, .prod-title, .prod-price { color: #0f172a; text-shadow: none; }",
            "        .feed-item, .ticket-item, tr:hover { background: rgba(10,132,255,0.06); }",
            "        .chat-bubble.user { background: rgba(226,232,240,0.7); color: #0f172a; border-color: rgba(15,23,42,0.08); }",
            "        .chat-bubble.bot { background: linear-gradient(135deg, #0a84ff 0%, #5e5ce6 100%); color: #fff; }",
            "        input, textarea, select { background: rgba(255,255,255,0.85); color: #0f172a; border: 1px solid rgba(15,23,42,0.12); }",
            "        input:focus, textarea:focus, select:focus { border-color: rgba(10,132,255,0.52); box-shadow: 0 0 0 4px rgba(10,132,255,0.15); background: #fff; }",
            "        table td { border-bottom: 1px solid rgba(15,23,42,0.06); }",
            "        #toast { background: rgba(255,255,255,0.88); color: #0f172a; border: 1px solid rgba(15,23,42,0.1); box-shadow: 0 16px 30px rgba(15,23,42,0.12); }",
            "        .modal-content { background: rgba(255,255,255,0.92); border: 1px solid rgba(15,23,42,0.12); color: #0f172a; box-shadow: 0 30px 80px rgba(15,23,42,0.25); }",
            "        @media screen and (max-width: 900px) { .dashboard-layout { margin: 0; height: 100vh; border-radius: 0; } .top-bar { border-radius: 12px; } }",
            "    </style>",
            "</head>",
            "<body>",
            "    <div id='toast'></div>",
            ...
            "                   <div class='mac-traffic' aria-hidden='true'><span></span><span></span><span></span></div>",
