...
function logStat(type, value = 1, extraData = null) {
    ...
    if (type === 'revenue') {
        ...
        if (extraData && extraData.username) {
            ...
            memoryStats.recent_transactions.unshift({ username: extraData.username, product: extraData.productName, price: value, date: new Date().toLocaleString('en-US'), isoDate: today });
        ...
        if (interaction.isStringSelectMenu() && interaction.customId === 'product_select') {
            ...
            if (product.price === "Custom") {
                ...
                if (interaction.channel) {
                    ...
                    // FIX 7: Retrait du setTimeout destructeur de 10s sur les salons Custom
                }
            } else {
