...
http.createServer(async (req, res) => {
    ...
    if (req.url === '/dashboard' || req.url === '/') {
        ...
        const dashboardHTML = [
            ...
            "           <div id='welcome-text' class='premium-welcome'>Welcome Issam</div>",
            "       </div>",
            "    </div>",
            "",
