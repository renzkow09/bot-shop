...
let memoryStats = { 
    ...
    custom_requests: [], user_history: {}, warns: {}, blacklist: [], last_update: Date.now() 
};
    ...
    try {
        ...
        if (interaction.isStringSelectMenu() && interaction.customId === 'product_select') {
            ...
            if (["10", "11"].includes(selected)) {
                ...
                logStat('revenue', parseInt(priceMatch[0]), { productId: selected, productName: product.name, username: interaction.user.username });
                    ...
                    <div class="content-grid">
                        ...
                        <div class="box">
                            ...
                            <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom:1px solid var(--border-color);">
                                ...
                                <button class="admin-btn" onclick="sendAdminAction('announce')">📢 Send Announcement</button>
                            </div>
                            <div>
                                <label class="text-muted">Emergency Controls</label><br>
                                <button class="admin-btn" style="background:var(--accent-red);" onclick="sendAdminAction('close_all')">🗑️ Close All Open Tickets</button>
                            </div>
                        </div>
                    </div>
                </div>
