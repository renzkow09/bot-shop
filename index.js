...
function logStat(type, value = 1, extraData = null) {
    ...
    if (type === 'revenue') {
        ...
        if (!Array.isArray(memoryStats.recent_transactions)) memoryStats.recent_transactions = []; // Correction structure
        ...
        req.on('end', async () => {
            try {
                ...
                if (data.action === 'edit_product') {
                    ...
                    if (!reviewChannel) return res.writeHead(400).end('Reviews channel not found');
