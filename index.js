    ...
    if (message.content.startsWith('!redeem ')) {
        ...
        try {
            ...
            if (response.data && response.data.success) {
                ...
                try {
                    // Pense à remplacer la ligne ci-dessous par ton vrai lien de téléchargement
