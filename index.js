...
http.createServer(async (req, res) => {
    ...
    if (req.url === '/dashboard' || req.url === '/') {
        ...
        const dashboardHTML = [
            ...
            "        .ticket-item { padding: 15px; background: rgba(255,255,255,0.02); border-radius: 12px; cursor: transition: all 0.3s; font-weight: 600; font-size: 0.9em; border: 1px solid transparent; }",
