...
http.createServer(async (req, res) => {
    ...
    if (req.url === '/dashboard' || req.url === '/') {
        ...
        const dashboardHTML = [
            ...
            "        ",
            "        /* LAYOUT & SIDEBAR - ANTI-BLUR MOBILE PROTOCOL */",
            ...
            "        .sidebar { width: 280px; background: #0b0f19; border-right: 1px solid var(--border-color); padding: 25px 20px; display: flex; flex-direction: column; overflow-y: auto; z-index: 10000; flex-shrink: 0; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); -webkit-font-smoothing: antialiased; backface-visibility: hidden; }",
            "        .sidebar-closed .sidebar { margin-left: -280px; }",
            ...
            "          .sidebar { position: fixed; top: 0; left: 0; height: 100vh; transform: translateX(-100%); width: 280px; box-shadow: 20px 0 50px rgba(0,0,0,0.5); margin-left: 0 !important; }",
            "          .sidebar.open { transform: translateX(0); }",
            "          .sidebar-closed .sidebar { margin-left: 0 !important; transform: translateX(-100%); }",
