...
<head><link rel='icon' href='data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>⚡</text></svg>'>
    ...
    <style>
        ...
        * { box-sizing: border-box; } 
        ...
        .nav-badge { background: var(--accent-red); color: white; border-radius: 12px; padding: 2px 8px; font-size: 0.7em; font-weight: 800; margin-left: auto; box-shadow: 0 0 10px rgba(var(--accent-red-rgb), 0.5); }
