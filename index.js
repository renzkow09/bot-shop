       ...
       <main class='main-content'>
           ...
           <div id='vip' class='tab-content'>
               <div class='box' style='background:rgba(168,85,247,0.05); border-color:rgba(168,85,247,0.3);'>
                   ...
                   <p class='text-muted'>Active subscriptions. VIPs get an automatic 20% discount on all shop items.</p><div style='overflow-x:auto; margin-top:20px;'><table><thead><tr><th>Username</th><th>Expires On</th><th>Time Left</th><th>Actions</th></tr></thead><tbody id='target-vips'></tbody></table></div>
               </div>
           </div>
                       ...
                       <div class='chat-window'>
                           ...
                           <div class='chat-input-area'>
                               <div class='chat-attachment-wrapper'>
                                   ...
                                   <button class='chat-attachment-btn' onclick='document.getElementById("chat-file-input").click()' title='Attach Image' style='background:none;border:none;color:#fff;font-size:1.2em;cursor:pointer;'>📎</button>
                                   <div id='attach-badge' class='attachment-badge' style='display:none;width:8px;height:8px;background:var(--accent-green);border-radius:50%;position:absolute;top:-2px;right:-2px;'></div>
                               </div>
