...
http.createServer(async (req, res) => {
    ...
    if (req.url === '/dashboard' || req.url === '/') {
        ...
        const dashboardHTML = [
            ...
            ".network-icon.morph .bar-4 { height: 34px; background: var(--accent-blue); box-shadow: 0 0 20px var(--accent-blue); }",
            ...
            "#welcome-text { position: absolute; bottom: -40px; color: var(--accent-blue); font-size: 1rem; font-weight: 600; letter-spacing: 6px; text-transform: uppercase; opacity: 0; transform: translateY(10px); transition: all 1s ease 1s; width: 100%; text-align: center; text-shadow: 0 0 10px rgba(56,189,248,0.5); }",
            "#welcome-text.show { opacity: 1; transform: translateY(0); }",
            ".loading-text { position: absolute; bottom: -40px; color: var(--accent-blue); font-weight: 800; font-size: 1.2em; letter-spacing: 3px; text-shadow: 0 0 10px rgba(56,189,248,0.5); transition: opacity 0.5s; width: 100%; text-align: center; }",
            ...
            "       if(progress < 90) { progress += Math.random() * 5; if(progress > 90) progress = 90; loadTxt.innerText = Math.floor(progress) + '%'; }",
            "       if(progress > 25) bars[0].classList.add('active');",
            "       if(progress > 50) bars[1].classList.add('active');",
            "       if(progress > 75) bars[2].classList.add('active');",
            "   }, 50);",
            "   try{",
            ...
            "           loadTxt.innerText = '100%';",
            "           bars[3].classList.add('active');",
            "           setTimeout(() => {",
            "               loadTxt.classList.add('hide');",
            "               document.getElementById('network-icon').classList.add('morph');",
            "               playPremiumIntro();",
            "               setTimeout(() => {",
            "                   document.getElementById('logo-ssam').classList.add('show');",
            ...
            "           }, 400);",
            "       } else {",
            "           loadTxt.innerText = Math.floor(progress) + '%';",
            "       }",
            "   }, 20);",
            "}",
